...
2. Use **Add Credit** to top up the Supabase balance.
3. Click **Simulate paid API call** to hit the vendor service. The dashboard shows live trace logs from both Vercel (Next) and DigitalOcean (vendor).
4. Use **Reset balance** to drop the credits back to zero and rerun the simulation to show a 402 response.
